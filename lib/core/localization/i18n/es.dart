const Map<String, String> esKeys = {
  ...
  'login_subtitle': '¡Hola de nuevo! Ingresa a tu cuenta para continuar',
  'welcome_title': 'Bienvenido a Conexiate',
  'welcome_subtitle':
      'Tu plataforma integral de beneficios comerciales, convenios empresariales y fidelización en un solo lugar.',
  'email': 'Correo Electrónico',
  'email_hint': 'ejemplo@correo.com',
  'password': 'Contraseña',
  'password_hint': 'Ingresa tu contraseña',
  'login_button': 'Iniciar Sesión',
  'login_loading': 'Verificando tus datos...',
  'email_required': 'Por favor ingresa tu correo electrónico',
  'invalid_email': 'Ingresa un correo electrónico válido (ej: usuario@correo.com)',
  ...
  'register_subtitle': 'Crea tu cuenta en sencillos pasos y accede a todos los beneficios',
  'register_button': 'Crear Cuenta',
  'register_success': '¡Cuenta creada con éxito! Ya puedes acceder a la plataforma.',
